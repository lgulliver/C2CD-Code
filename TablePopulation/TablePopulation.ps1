...
# specify parameters
$storageAccountName = "dansinventorytest"
$resourceGroupName = "WineShopDev"
$tableName = "test"
...
Insert-Row -table $table -partitionKey "Red" -rowKey "0" -wineInStock 10 -winePrice 13.95 -wineName "Châteauneuf Du Pape Les Courlandes 75cl" -winePicture "http://www.sainsburys.co.uk/wcsstore7.23.1.52/ExtendedSitesCatalogAssetStore/images/catalog/productImages/82/3142806758482/3142806758482_L.jpeg" -wineInfo "The village of Châteauneuf du Pape in the southern Rhône valley is named after the new château built by the Popes as a summer residence in the 14th century. Its vineyards, first planted in Roman times, and covered with rolled pebbles, are renowned for their rich, ripe, generous wines"
...
Insert-Row -table $table -partitionKey "Rose" -rowKey "0" -wineInStock 12 -winePrice 9.97 -wineName "Mondelli Sparkling Rosé 75cl" -winePicture "http://www.sainsburys.co.uk/wcsstore7.23.1.52/ExtendedSitesCatalogAssetStore/images/catalog/productImages/63/8005415048663/8005415048663_L.jpeg" -wineInfo "This sweet sparkling rosé is soft and fruity with flavours of lusciously ripe strawberries. Serve well-chilled with summer berry desserts."
